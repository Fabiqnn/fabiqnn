                ...
                <div className="md:w-2/4 mx-auto">
                    <div className="flex flex-col text-center space-y-3 items-center md:mt-20">
                        ...
                        <div className={`flex w-14 h-14 place-items-center rounded-2xl transition-colors duration-200 ${dark ? "bg-[#1f1f1f]" : "bg-transparent ring ring-[#1f1f1f]"}`}>
                            <img src="/assets/laravel.png" alt="" className=""/>
                        </div>
                    </div>
                    ...
                    <div className="mb-10 ">
                        <img src="/assets/fixit.png" alt="" className={`border-2 mx-auto rounded border-[#1f1f1f]`}/>
                    </div>
                    ...
                    <div className="space-y-10">
                        <div className="space-y-2">
                            <img src="/assets/pelaporan.png" alt="" className={`border-2 mx-auto rounded border-[#1f1f1f]`}/>
                        ...
                        <div className="space-y-2">
                            <img src="/assets/tracking.png" alt="" className={`border-2 mx-auto rounded border-[#1f1f1f]`}/>
                        ...
                        <div className="space-y-2">
                            <img src="/assets/spk.png" alt="" className={`border-2 mx-auto rounded border-[#1f1f1f]`}/>
